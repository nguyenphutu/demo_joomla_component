...
$document->addStyleDeclaration('.icon-student {background-image: url(../media/com_student/images/tux-16x16.png);}');
...
// Require helper file
JLoader::register('StudentHelper', JPATH_COMPONENT . '/helpers/student.php');
