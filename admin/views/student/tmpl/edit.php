...
<form action="<?php echo JRoute::_('index.php?option=com_student&layout=edit&id=' . (int) $this->item->id); ?>"
    ...
    <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', 
        empty($this->item->id) ? JText::_('COM_STUDENT_TAB_NEW_MESSAGE') : JText::_('COM_STUDENT_TAB_EDIT_MESSAGE')); ?>
        <fieldset class="adminform">
            <legend><?php echo JText::_('COM_STUDENT_LEGEND_DETAILS') ?></legend>
            <div class="row-fluid">
                <div class="span6">
    ...
    <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'params', JText::_('COM_STUDENT_TAB_PARAMS')); ?>
        <fieldset class="adminform">
            <legend><?php echo JText::_('COM_STUDENT_LEGEND_PARAMS') ?></legend>
            <div class="row-fluid">
                <div class="span6">
    ...
    <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'permissions', JText::_('COM_STUDENT_TAB_PERMISSIONS')); ?>
        <fieldset class="adminform">
            <legend><?php echo JText::_('COM_STUDENT_LEGEND_PERMISSIONS') ?></legend>
            <div class="row-fluid">
                <div class="span12">
